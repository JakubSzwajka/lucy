  ...
  paths: {
    ...
    "/api/integrations": {
      get: {
        ...
        responses: {
          "200": {
            description: "List of integrations with their state",
            content: {
              "application/json": {
                schema: {
                  type: "array",
    ...
    "/api/integrations/{id}": {
      ...
      patch: {
        tags: ["Integrations"],
        summary: "Update integration credentials/config",
      ...
      delete: {
        tags: ["Integrations"],
        summary: "Remove integration credentials",
      ...
      post: {
        ...
        responses: {
          "200": {
            ...
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/IntegrationTestResult" },
              },
            },
          },
          "400": {
    ...
    schemas: {
      ...
      Integration: {
        ...
        properties: {
          ...
          hasTestConnection: { type: "boolean" },
          enabled: { type: "boolean" },
        ...
        required: ["id", "name", "description", "credentialFields", "configFields", "hasTestConnection", "enabled", "isConfigured"],
      },
      IntegrationUpdate: {
        type: "object",
        properties: {
