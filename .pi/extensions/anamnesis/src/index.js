...
import { ContinuityFramework, createSendMessage } from './framework/src/index.js';
...
const DEFAULT_CONFIG = {
  memoryDir: process.env.CONTINUITY_MEMORY_DIR ||
    join(process.cwd(), '.agents', 'experience', 'memory'),
  idleThreshold: parseInt(process.env.CONTINUITY_IDLE_THRESHOLD || '1800'),
  minMessages: parseInt(process.env.CONTINUITY_MIN_MESSAGES || '2'),
